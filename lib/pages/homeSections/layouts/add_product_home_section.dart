...
class AddProduct extends StatelessWidget {
  ...
  const AddProduct({Key? key , childrenList});
    ...
    return StatefulBuilder(
        builder: (BuildContext context, StateSetter setState) {
          return GetBuilder<HomeSectionsController>(builder: (bannerCtrl) {
            ...
            print("Product list: ${bannerCtrl.productList!.length}");
                          ...
                          Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
                            ...
                            Padding(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(
                                            child: DropdownButton(
                                                ...
                                                items: bannerCtrl.productList.map((product_model.Product collection) {
                                                ...
                                                onChanged: (val){
                                                  ...
                                                  setState((){
                                                    bannerCtrl.txtTitle.text = bannerCtrl.productList.where((element) => element.id == val).first.name!;
                                                    bannerCtrl.txtTitleAr.text = bannerCtrl.productList.where((element) => element.id == val).first.name!;
                                                    bannerCtrl.txtId.text = bannerCtrl.productList.where((element) => element.id == val).first.id!;
                                                    bannerCtrl.imageUrl = bannerCtrl.productList.where((element) => element.id == val).first.images[0]!;
                                                    bannerCtrl.imageUrlAr = bannerCtrl.productList.where((element) => element.id == val).first.images[0]!;
                                                  });
                                      ...
                                      //             return CupertinoSwitch(value: bannerCtrl.isSectionShown!.value, onChanged: (val)async{
                                      //               setState((){
                                      ...
                                      //     showDialog(context: context, builder: (context) {
                                      //
                                      //       bannerCtrl.addNewTitle.clear();
                                      //       bannerCtrl.addNewBanner.clear();
                                      //       bannerCtrl.addNewId.clear();
                                      //
                                      //       print("ID CTRL"+bannerCtrl.addNewId.text);
                                      //       return AlertDialog(
                                      //         content: Container(
                            ...
                            CommonButton(
                                ...
                                title: bannerCtrl.isLoading
                                    ...
                                    : fonts.submit.tr,
                                onTap: () async{
                                  await bannerCtrl.uploadFile(context);
                                  // await  bannerCtrl.uploadFileAr();
                                  //   bannerCtrl.saveHomeSection(context);
                                },
