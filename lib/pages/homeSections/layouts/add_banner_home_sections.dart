...
class AddSection extends StatelessWidget {
  ...
  const AddSection({Key? key , childrenList});
  ...
  Widget build(BuildContext context) {
    ...
    return StatefulBuilder(
      ...
      return GetBuilder<HomeSectionsController>(builder: (bannerCtrl) {
        ...
        print("Home list: ${bannerCtrl.homeCategoryList.length}");
                                        ...
                                        child: DropdownButton(
                                          ...
                                          hint: Text("Choose collection"),
                                            ...
                                            onChanged: (val){
                                              ...
                                              bannerCtrl.imageUrl = bannerCtrl.homeCategoryList.where((element) => element.id == val).first.image!;
                                                bannerCtrl.imageUrlAr = bannerCtrl.homeCategoryList.where((element) => element.id == val).first.image!;
                                              });
